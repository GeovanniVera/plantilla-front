                ...
                <tbody>
                    {data.length === 0 ? (
                        ...
                        data.map((row, rowIndex) => (
                            ...
                            >
                                {leadingColumn && (
                                    <td className={leadingColumn.className}>
                                        {leadingColumn.cell?.(rowIndex)}
                                    </td>
                                )}
                                {columns.map((col, columnIndex) => {
                                    const value = getCellValue(row, col.key)
                                    const composed = composeCell?.({ row, rowIndex, column: col, columnIndex, value })
