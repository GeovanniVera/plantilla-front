...
const TOGGLE_TRACK_BASE_CLASSES = 'relative w-8 h-[18px] rounded-full bg-border-base transition-colors duration-150 ease-in-out shrink-0'
    ...
    return (
        ...
        >
            <div className={`${TOGGLE_TRACK_BASE_CLASSES} ${isActive ? TOGGLE_TRACK_ON_CLASSES : ''}`}>
                <div className={`${TOGGLE_THUMB_BASE_CLASSES} ${isActive ? TOGGLE_THUMB_ON_CLASSES : ''}`} />
            </div>
